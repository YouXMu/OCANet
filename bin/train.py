...
def main(config: OmegaConf):
    try:
        ...
        # if config.training_model.checkpoint :
        #     training_model = load_checkpoint(config, config.training_model.checkpoint,tag=config.training_model.tag)
        # else:
        ...
        trainer = Trainer(
            ...
            resume_from_checkpoint=config.training_model.checkpoint,
            **trainer_kwargs
        )
